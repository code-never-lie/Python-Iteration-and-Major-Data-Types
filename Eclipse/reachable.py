...
@author: Ahmadraza161
'''
#import goody  unless use 
#import prompt  unless use
#from collections import  unless use
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if starter not in graph_dict:
            print('''Entry Error: '{}';  Not a source node Please enter a legal String'''.format(starter))
            continue
